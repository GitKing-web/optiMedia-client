            ...
            <header class="flex flex-col md:flex-row justify-between md:items-center gap-6 mb-12 relative z-10">
                ...
                <div class="flex items-center gap-6">
                    <button
                        ...
                        class="bg-white/5 px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest text-white/60 hover:text-white transition-colors"
                    >
                        Back to Dashboard
                    </button>
                </div>
                            ...
                            <tbody class="divide-y divide-white/5">
                                <tr v-for="user in filteredUsers" :key="user.userId" class="hover:bg-white/5 transition-all">
                                    ...
                                    <td class="py-5 sm:py-6 px-4 sm:px-6 text-right whitespace-nowrap">
                                        <button v-if="user.status === 'pending'" @click="activateSubscription(user.userId)" class="bg-emerald-500 text-white px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-emerald-600 transition-all shadow-lg hover:-translate-y-0.5 hover:shadow-emerald-500/20 active:scale-95">
                                            Activate Sub
                                        </button>
                                ...
                                <tr v-if="filteredUsers.length === 0">
                                    <td colspan="6" class="py-12 text-center text-white/30 font-bold uppercase tracking-widest">
